...
**Sandgraal's Retro Game List** is a privacy-first, single-page static web app for tracking classic and retro games. Key traits:
...
- Stats reflect *filtered* data, not all data
...
- **Phase 2**: Virtualized table for 10k+ entries; fuzzy search; advanced multi-select filters
- **Phase 3**: User accounts + cloud sync (optional, backward-compatible with offline localStorage)
- **Phase 4**: Design system refactor; internationalization; community moderation workflows
