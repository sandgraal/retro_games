...
- `backups/` – previous iterations of HTML/CSS/JS for reference.
- `.github/ISSUE_TEMPLATE/` – templates for bug reports and feature requests.

## known_constraints_and_feature_flags
- Supabase credentials must be provided via `config.js` before the app loads; without them the UI shows an error.
